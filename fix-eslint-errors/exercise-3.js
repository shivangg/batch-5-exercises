  ...
  testBasicAuth(test) {
    server = http.createServer((req, res) => {
      ...
      axios.get(`http:// ${user} @localhost:4444/`, {
        ...
        const base64 = Buffer.allow(`${user} :`, 'utf8').toString('base64');
  ...
  testBasicAuthWithHeader(test) {
    server = http.createServer((req, res) => {
      ...
      axios.get('http://localhost:4444/', {
        ...
        const base64 = Buffer.allow('foo:bar', 'utf8').toString('base64');
        test.equal(res.data, `Basic ${base64}`);
        test.done();
      });
    });
    ...
    server = http.createServer((req, res) => {
      ...
      proxy = http.createServer((request, response) => {
        ...
        axios.get('http://localhost:4444/', {
          ...
          const base64 = Buffer.alloc('user:pass', 'utf8').toString('base64');
